...
public class AtCommandResponse extends XBeeFrameIdResponse {
	...
	public static class Status {
		public static Status OK = new Status(new Integer(0));
		public static Status ERROR = new Status(new Integer(1));
		public static Status INVALID_COMMAND = new Status(new Integer(2));
		public static Status INVALID_PARAMETER = new Status(new Integer(3));
		// series 1 remote AT only according to spec. also series 2 in 2x64 zb
		// pro firmware
		public static Status NO_RESPONSE = new Status(new Integer(4));
	...
	/**
	 * Returns the command data byte array. A zero length array will be returned
	 * if the command data is not specified. This is the case if the at command
	 * set a value, or executed a command that does not have a value (like FR)
	 * 
	 * @return
	 */
	public int[] getValue() {
	...
	public String getCommand() {
		return String.valueOf((char) this.char1)
				+ String.valueOf((char) this.char2);
	}
	...
	public void parse(IPacketParser parser) throws IOException {
		...
		this.setStatus(Status
				.get(new Integer(parser.read("AT Response Status"))));
	...
	public String toString() {
		return "command="
				...
				+ this.getStatus()
				+ ",value="
				+ (this.value == null ? "null" : ByteUtils.toBase16(this
						.getValue())) + "," + super.toString();
	}
}