...
public class XBee implements IXBee {
	...
	private XBeeResponse getResponseTimeout(Integer timeout) throws XBeeException, XBeeTimeoutException {
		...
		try {
			if (timeout != null) {
				response = (XBeeResponse)parser.getResponseQueue().poll(timeout.longValue(), TimeUnit.MILLISECONDS);	
			} else {
...
//	}
	 ...
	 */
	//<? extends XBeeResponse>
	public List collectResponses(int wait, CollectTerminator terminator) throws XBeeException {
