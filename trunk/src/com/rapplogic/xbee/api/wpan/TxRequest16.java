...
/**
 * Series 1 XBee. 16-bit address Transmit Packet. This is received on the
 * destination XBee radio as a RxResponse16 response
 * <p/>
 * API ID: 0x1
 * <p/>
 * 
...
public class TxRequest16 extends TxRequestBase {
	...
	private static final long serialVersionUID = 5682352651132620443L;
	private XBeeAddress16 remoteAddr16;

	/**
	 * 16 bit Tx Request with default frame id and awk option
	 * 
	 * Keep in mind that if you programmed the destination address with X-CTU,
	 * the unit is hex, so if you set MY=1234, use 0x1234.
	 * 
	 * @param remoteAddr16
	 * @param payload
	 */
	public TxRequest16(XBeeAddress16 remoteAddr16, int[] payload) {
		this(remoteAddr16, DEFAULT_FRAME_ID, UNICAST, payload);
	}
	...
	public TxRequest16(XBeeAddress16 remoteAddr16, int frameId, int[] payload) {
		this(remoteAddr16, frameId, UNICAST, payload);
	}
	 ...
	 * @param option
	 */
	public TxRequest16(XBeeAddress16 remoteAddr16, int frameId, String option,
			int[] payload) {
